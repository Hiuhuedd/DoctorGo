...
const AccountScreen = ({ navigation }) => {
    ...
    return (
        <View style={{ backgroundColor: "#FBFBFB", height: "100%", paddingTop: 20 }}  >
                ...
                <View style={{ position: "relative", width: "100%", alignItems: "center" }}>
                    ...
                    <ViewAtom fd="column" ai="center" w="100%" pv={0} ph={0} bg="transparent" br={0} mv={0} mh={0}>
                        ...
                        <ViewAtom ai="center" jc="center" pv={3} ph={3} br={50} mv={20} mh={5} >
                            <ImageBackground source={Avatar} style={{ width: 100, height: 100 }} resizeMode="cover" borderRadius={50} >
                            </ImageBackground>
                        </ViewAtom>
                        ...
                        <TextAtom text="Hiuhu Edward" c={COLORS.black} f="Poppins" s={SIZES.h5} w="500" />
                    </ViewAtom>
                        <ViewAtom
                                fd="row"
                                jc="space-between"
                            ...
                            >
                             <Feather name="map-pin" size={SIZES.base} color={COLORS.black} />   
                             <TextAtom text="   Nairobi,  Kasarani, Red-soil"  c={COLORS.black} f="Poppins" s={SIZES.base} w="500" />
            ...
            <ViewAtom  fd="row" jc="space-between" ai="flex-start" pv={10}  ph={10}bg={COLORS.primaryShade} br={50}
                                mv={0} mh={5}     >
                                <Feather name={setting.icon} size={SIZES.h5} color={COLORS.black} />
                            </ViewAtom>
