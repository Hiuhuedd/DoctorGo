...
const ChatScreen = ({route,navigation}) => {
  ...
  return (
    <View style={{   height:SIZES.height, paddingTop: 0 ,backgroundColor:COLORS.primaryShade}}  >
      ...
      <CardAtom fd="column" jc="center" ai="center" bg={COLORS.primary} ph={10} pv={5} br={5} mh={4} >
        <Icon name="videocam-outline" size={SIZES.body3} type='ionicon' color={COLORS.white} /> 
      
        </CardAtom>
      <CardAtom fd="column" jc="center" ai="center" bg={COLORS.primary} ph={10} pv={5} br={5} mh={4} >
        <Icon name="call-outline" size={SIZES.body3} type='ionicon' color={COLORS.white} /> 
