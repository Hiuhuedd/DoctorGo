...
import { Deli } from '../../constants/images';
const {COLORS, SIZES, FONTS}=appTheme
const BottomSheetDeli = React.forwardRef(({onMethodSelected,navigation,nearestclinic,photoUrl,state}, ref) => {
    ...
    <RBSheet
      ...
      >
          <View style={styles.bottomCard}>
                ...
                <Text style={styles.text}>Your medicines are on the way.. </Text>
                ...
                <Image style={styles.userImg}  source={Deli}
   />
                <Text style={styles.text__}>Mike </Text>
                </View>
                    <View  style={styles.Option} >
       ...
       <Button text={"Proceed"}width="100%" bg={COLORS.primary} navigation={navigation} borderRadius={5} screen="Medicine"  onMethodSelected={onMethodSelected}/>
                    </View>
            </View>
    </RBSheet>
  );
...
export default BottomSheetDeli;